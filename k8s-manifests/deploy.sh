...
kubectl apply -f ./k8s-manifests/deployment.yaml --validate=false --insecure-skip-tls-verify
...
kubectl apply -f ./k8s-manifests/service.yaml --validate=false --insecure-skip-tls-verify
